...
export const DEFAULT_TEMPLATES: Template[] = [
  ...
  },
  {
    ...
    sections: [
      ...
      sec('vis25-statement', 'Vision Statement',                                         3),
      sec('vis25-whynow',    'Why Now — compressed current state + market/user shift',   4),
      sec('vis25-pillars',   'Pillars — with users embedded',                            8),
      sec('vis25-metrics',   'Success Metrics',                                          3),
      sec('vis25-roadmap',   'Roadmap — near-term',                                      3),
  ...
  },
  {
    ...
    sections: [
      ...
      sec('strat25-whyus',      'Why Us — market/assets',                           5),
      sec('strat25-whynow',     'Why Now — timing',                                 3),
      sec('strat25-cost',       'At What Cost — opportunity cost, feasibility',     4),
